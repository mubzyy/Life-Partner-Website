...
const HowItWorks = () => (
  <section id="how" style={{ padding: "80px 24px", background: "#f7f5f0" }}>
    <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>

      <p style={{ fontSize: 12, fontWeight: 800, letterSpacing: "0.15em", color: "#d4a843", textTransform: "uppercase", marginBottom: 12 }}>
        HOW IT WORKS
      </p>
      <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 700, color: "#1a2e2b", margin: "0 0 60px" }}>
        Simple Steps to Find Your Life Partner
      </h2>

      {/* Steps with connecting lines */}
      <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }} className="how-grid">
        {/* Connecting line */}
        <div style={{
          position: "absolute",
          top: 28,
