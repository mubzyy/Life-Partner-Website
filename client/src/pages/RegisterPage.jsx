    ...
    <div className="hidden xl:block absolute inset-0 z-[-1] pointer-events-none overflow-hidden bg-background">
      ...
      <div className="hidden xl:flex absolute left-8 top-1/2 -translate-y-1/2 flex-col items-center gap-10 opacity-95">
        ...
        <div className="animate-[floatFast1_8s_ease-in-out_infinite] ml-0">
          <div className={`w-[180px] h-[180px] rounded-[24px] overflow-hidden border border-border-light shadow-sm shadow-sm transition-all duration-700 ease-in-out ${fadeStatus[0] ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
        ...
        <div className="animate-[floatFast2_11s_ease-in-out_infinite] ml-32">
          <div className={`w-[250px] h-[250px] rounded-[32px] overflow-hidden border border-border-light shadow-sm shadow-sm transition-all duration-700 ease-in-out ${fadeStatus[1] ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
        ...
        <div className="animate-[floatFast3_9s_ease-in-out_infinite] -ml-8">
          <div className={`w-[140px] h-[140px] rounded-[20px] overflow-hidden border border-border-light shadow-sm shadow-sm transition-all duration-700 ease-in-out ${fadeStatus[2] ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
      ...
      <div className="hidden xl:flex absolute right-8 top-1/2 -translate-y-1/2 flex-col items-center gap-10 opacity-95">
        ...
        <div className="animate-[floatFast3_10s_ease-in-out_infinite] -mr-8">
          <div className={`w-[140px] h-[140px] rounded-[20px] overflow-hidden border border-border-light shadow-sm shadow-sm transition-all duration-700 ease-in-out ${fadeStatus[3] ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
        ...
        <div className="animate-[floatFast2_12s_ease-in-out_infinite] mr-32">
          <div className={`w-[250px] h-[250px] rounded-[32px] overflow-hidden border border-border-light shadow-sm shadow-sm transition-all duration-700 ease-in-out ${fadeStatus[4] ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
        ...
        <div className="animate-[floatFast1_9s_ease-in-out_infinite] mr-0">
          <div className={`w-[180px] h-[180px] rounded-[24px] overflow-hidden border border-border-light shadow-sm shadow-sm transition-all duration-700 ease-in-out ${fadeStatus[5] ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
...
const RegisterPage = () => {
  ...
  const inputClasses = "w-full box-border pl-10 pr-4 py-2.5 sm:py-3 rounded-[14px] border-[1.5px] border-border-light bg-card text-[14px] text-text-primary outline-none transition-all duration-200 hover:border-slate-300 focus:ring-2 focus:ring-primary-light focus:border-primary transition-colors";
  const labelClasses = "block text-[13px] font-bold text-text-primary mb-1.5";
    ...
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden z-0 bg-background">
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
          <div className="bg-card rounded-[24px] p-8 max-w-sm w-full shadow-2xl flex flex-col items-center text-center animate-in fade-in zoom-in duration-200">
            <div className="w-16 h-16 bg-primary-very-light text-primary rounded-full flex items-center justify-center mb-6">
              <CheckCircle2 size={32} />
            </div>
            <h3 className="text-[22px] font-bold text-text-primary mb-2">Account Created</h3>
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl text-white font-bold text-[15px] transition-all bg-primary hover:bg-primary-hover text-white rounded-xl shadow-sm hover:scale-105 transition-all"
            >
              Continue to Login
            </button>
          </div>
      ...
      {showOtpModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="bg-card rounded-[28px] p-8 max-w-md w-full shadow-2xl flex flex-col items-center text-center">
            {/* Icon */}
            <div className="w-16 h-16 bg-primary-very-light rounded-full flex items-center justify-center mb-5">
            ...
            <h3 className="text-[22px] font-bold text-text-primary mb-2">Check your email</h3>
            <p className="text-[14px] text-text-secondary mb-1 leading-relaxed">
              We've sent a 6-digit verification code to
            </p>
            <p className="text-[14px] font-bold text-primary mb-6">{email}</p>
            ...
            <input
              ...
              className="w-full text-center text-[28px] font-bold tracking-[12px] py-4 px-4 rounded-xl border-[2px] border-border-light bg-background text-text-primary outline-none transition-all focus:border-primary focus:bg-card focus:shadow-sm mb-5"
            />
            ...
            <button
              ...
              className={`w-full py-3.5 rounded-xl text-white font-bold text-[15px] transition-all mb-4 ${
                otpLoading || otpValue.length !== 6
                  ...
                  : 'bg-primary hover:bg-primary-hover text-white rounded-xl shadow-sm hover:scale-105 transition-all cursor-pointer'
              }`}
            >
            ...
            <button
              ...
              className="mt-4 text-[12px] text-text-muted hover:text-text-secondary transition-colors cursor-pointer bg-transparent border-none"
            >
      ...
      <div className="flex flex-col items-center justify-center px-4 py-8 lg:py-12 z-10 relative w-full">
        ...
        <div className="w-full max-w-3xl">
          <div className="bg-card rounded-[32px] p-6 sm:p-8 md:p-10 shadow-sm relative overflow-hidden">
            ...
            <div className="text-center mb-6 flex flex-col items-center">
              <div className="flex items-center gap-4 mb-2">
                ...
                <h1 className="font-serif text-[32px] md:text-[40px] font-bold text-text-primary text-text-primary font-bold m-0">
                  Create your account
                </h1>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  <label className={labelClasses}>Middle Name <span className="font-normal text-text-muted">(Opt)</span></label>
                  <div className="relative">
                    <User className={iconClasses} />
                    <input
                      type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    ...
                    <ChevronDown size={16} className={`text-text-muted transition-transform ${showCountryDropdown ? "rotate-180" : ""}`} />
                  </div>
                  
                  {showCountryDropdown && (
                    <div className="absolute z-50 w-full mt-2 bg-card border border-border-light rounded-xl shadow-sm overflow-hidden">
                      <div className="flex items-center gap-2 p-3 border-b border-slate-100 bg-background">
                        <Search size={16} className="text-text-muted ml-1" />
                        <input type="text" placeholder="Search countries..." className="w-full text-[14px] p-1 bg-transparent outline-none text-text-primary" value={countrySearch} onChange={(e) => setCountrySearch(e.target.value)} autoFocus />
                      </div>
                      <div className="max-h-[220px] overflow-y-auto py-1">
                        {filteredCountries.length > 0 ? (
                          filteredCountries.map(c => (
                            <div key={c.id} className="flex items-center gap-3 px-4 py-2.5 hover:bg-background cursor-pointer text-[14px] text-text-primary transition-colors" onClick={() => { setSelectedCountry(c); setPhoneCode(c.phone_code); setShowCountryDropdown(false); setCountrySearch(""); }}>
                              {c.name}
                            </div>
                          ))
                        ) : (
                          <div className="p-4 text-center text-text-secondary text-[13px]">No countries found</div>
                        )}
                      </div>
                    </div>
                  )}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative w-[110px]">
                      <select value={phoneCode} onChange={e => setPhoneCode(e.target.value)} className={`w-full box-border px-3 py-2.5 sm:py-3 rounded-[14px] border-[1.5px] border-border-light bg-card text-[14px] text-text-primary outline-none transition-all duration-200 hover:border-slate-300 focus:ring-2 focus:ring-primary-light focus:border-primary transition-colors cursor-pointer appearance-none bg-no-repeat bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20width%3D%2220%22%20height%3D%2220%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpath%20d%3D%22M5%208l5%205%205-5%22%20stroke%3D%22%2394a3b8%22%20stroke-width%3D%221.5%22%20fill%3D%22none%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%2F%3E%3C%2Fsvg%3E')] bg-[position:right_8px_center]`}>
                        {countries.map(c => (
                    ...
                    <input
                      ...
                      maxLength={15}
                      className={`flex-1 min-w-0 box-border px-4 py-2.5 sm:py-3 rounded-[14px] border-[1.5px] border-border-light bg-card text-[14px] text-text-primary outline-none transition-all duration-200 hover:border-slate-300 focus:ring-2 focus:ring-primary-light focus:border-primary transition-colors`}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                />
                <label htmlFor="terms" className="text-[13px] text-text-secondary cursor-pointer select-none">
                  I agree to the <a href="#" className="text-primary font-bold no-underline hover:underline">Terms of Service</a> and <a href="#" className="text-primary font-bold no-underline hover:underline">Privacy Policy</a>
                </label>
              </div>

              <button type="submit" disabled={loading} className={`w-full py-4 mt-2 rounded-[14px] text-white font-bold text-[15px] flex items-center justify-center gap-2 transition-all duration-300 ${loading ? 'bg-slate-400 cursor-not-allowed' : 'bg-primary hover:bg-primary-hover hover:-translate-y-0.5 shadow-sm hover:shadow-sm cursor-pointer'}`}>
          ...
          <p className="text-center text-[14px] sm:text-[15px] text-text-secondary mt-8 font-medium">
            Already have an account?{" "}
            <Link to="/login" className="text-primary font-bold no-underline hover:underline">Sign In</Link>
          </p>
